...
public class ShapeFrame extends JFrame {
    ...
    /**
     * The reference for the shape to paint
     */
    ...
    private void initGUI() {
        ...
        JButton westBtnHou = new JButton("A house!");
        westBtnHou.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                System.out.println("westBtnR has been clicked!!!");

                paintingShape = new BinaryShape(
                        new Triangle(Color.CYAN, new Point(200, 250), new Point(400, 250), new Point(300, 200)),
                        new Rectangle(new Point(250, 250), Color.DARK_GRAY, 100, 50));
