...
public class BallWorldModel {
	...
	/**
	 * The model to view update adapter
	 */
     ...
     */
    private static final int PAINT_TIME_SLICE = 20;
	 ...
	 */
	private SwitcherStrategy<IBallCmd> mySwitcherStrategy = new SwitcherStrategy<>();
	
	/**
	 * The error update strategy factory
	 */
	...
	/**
	 * The error paint strategy factory
	 */
	 ...
	 * @return The full name of the strategy
	 */
	 ...
	 * @param viewUpdateAdapter The view update adapter
	 */
	...
	/**
	 * Make a paint strategy factory
	 * @param classname The class name
	 * @return The paint stratgegy factory
	 */
