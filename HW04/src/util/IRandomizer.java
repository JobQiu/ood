...
/**
 * An random generator interface that generates random values of various types.
 */
public interface IRandomizer {
	/**
	 * Generates a random location point subject to the constraint that 0 {@literal <=} X {@literal <=} rect.width and 0 {@literal <=} Y {@literal <=} rect.height.
	...
	/**
	 * Generates a random location point subject to the constraint that 0 {@literal <=} X {@literal <=} dim.width and 0 {@literal <=} Y {@literal <=} dim.height.
	...
	/**
	 * Returns a random square Dimension, whose width is maxDim.width/2 {@literal <=} width {@literal <=} maxDim.width
